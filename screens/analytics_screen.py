...
#     parent_frame.grid_propagate(True)
#
...
#
#             if new_mode == last_mode[0]:
#                 return  # Skip redundant layout switch
...
#             print("[DEBUG] Window width < 600; skipping auto-resize to preserve layout responsiveness.")
#
#
#
